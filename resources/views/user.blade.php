      ...
      <div class="container">
        <div class="row large-gutters">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 ">
            <div class="ftco-media-1">
              <div class="ftco-media-1-inner">
                <a href="{{ url('detail')}}" class="d-inline-block mb-4"><img src="{{ asset('werehouse/images/putri2.jpg') }}" alt="FImageo" class="img-fluid"></a>
                <div class="ftco-media-details">
                  <h3>HD17 19 Utica Ave.</h3>
                  <p>Putra</p>
                  <p>308 m dari amikom</p>
                  <strong style="color: #37cfa2;">$20,000,000</strong>
                </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 ">
              <div class="ftco-media-1">
                  <div class="ftco-media-1-inner">
                    <a href="{{ url('detail')}}" class="d-inline-block mb-4"><img src="{{ asset('werehouse/images/putri2.jpg') }}" alt="Image" class="img-fluid"></a>
                    <div class="ftco-media-details">
                      <h3>HD17 19 Utica Ave.</h3>
                      <p>Putra</p>
                      <p>308 m dari amikom</p>
                ...
                <div class="ftco-media-1">
                    <div class="ftco-media-1-inner">
                      ...
                      <div class="ftco-media-details">
                        ...
                        <p>Putra</p>
                        <p>308 m dari amikom</p>
                        <strong style="color: aqua;">$20,000,000</strong>
                      </div>  
                    </div> 
                  </div>
            </div>
